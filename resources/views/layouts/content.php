                        ...
                        <div class="col-12 col-md-6 d-flex align-items-center justify-content-center">
                            <div class="col-12 col-lg-11 col-xl-10">
                                <div class="card-body p-3 p-md-4 p-xl-5">
                                    ...
                                    <img class="gobernacion_start d-sm-none" src="<?php asset('img/logo_gobernacion.svg'); ?>" alt="Logo Gobernacion">
                                            ...
                                            <div class="text-center mb-2">
                                                <a href="#!">
                                                    <img class="img-fluid d-none d-lg-inline-flex w-50"
                                                         src="<?php asset('img/logo_gobernacion.svg'); ?>"
                                                         alt="BootstrapBrain Logo">
                                                    <img class="img-fluid d-lg-none mt-5"
                                                         src="<?php asset('img/logo_alguarisa.png'); ?>"
                                                         alt="BootstrapBrain Logo">
                                                </a>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex gap-3 flex-column">
                                                <a href="<?= route('login'); ?>" class="btn btn-lg btn-outline-dark">
                                                    ...
                                                    <span class="ms-2 fs-6">Sistema de Atención al Ciudadano</span>
                                                </a>
                                            </div>
