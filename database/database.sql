...
INSERT INTO `sessions` (`id`, `users_id`, `ip_address`, `user_agent`, `user_client`, `user_os`, `rowquid`, `created_at`, `updated_at`) VALUES
	(1, 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36 Edg/133.0.0.0', '{"type":"browser","name":"Microsoft Edge","short_name":"PS","version":"133.0","engine":"Blink","engine_version":"133.0.0.0","family":"Internet Explorer"}', '{"name":"Windows","short_name":"WIN","version":"10","platform":"x64","family":"Windows"}', '13TEhkdx0xnJY38F', '2025-02-24 15:35:58', NULL);
...
-- Volcando datos para la tabla dashboard_nativo.users: ~2 rows (aproximadamente)
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `current_team_id`, `profile_photo_path`, `role`, `permissions`, `rowquid`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(2, 'antonny maluenga', 'gabrielmalu15@gmail.com', NULL, '$2y$10$rQP3KsjEE8gqGDw6Z5MdXuU8q6Mfl8QPtdG.Q/WtAZK2dvKgtCYHG', 'lCrLDyyXdrGJSdJYmZTBurZOtgubagxG', NULL, '2025-02-24 15:35:58', NULL, NULL, NULL, 0, NULL, 'RvzoNYKWIgS44D1i', '2025-02-24 15:35:58', '2025-02-24 15:35:59', NULL);
